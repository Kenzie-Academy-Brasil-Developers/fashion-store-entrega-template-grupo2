      ...
      <main className="w-full mx-auto min-h-screen flex flex-col gap-10 py-16 overflow-hidden">
        <div className="w-5/6 flex flex-col lg:flex-row gap-14 mx-auto lg:relative">
          ...
          <div className="w-2/3 lg:w-full mx-auto lg:items-start flex flex-col items-center gap-14 lg:gap-0">
            <h1 className="leading-tight lg:text-left font-oswald uppercase text-center font-medium text-7xl sm:text-6xl lg:text-7xl tracking-wide lg:absolute lg:top-[10%] xl:top-[15%]">
              Kenzie Fashion Store
            </h1>
            <button className="btn btn-primary lg:text-lg text-2xl lg:w-fit font-thin px-6 h-fit lg:h-auto tracking-widest font-oswald w-full sm:w-fit rounded-none lg:absolute lg:bottom-[10%] xl:bottom-[15%]">
              Confira as ofertas
            </button>
          </div>
        </div>
